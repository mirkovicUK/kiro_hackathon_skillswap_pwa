...
- [x] 1. Create shared layout components
  - [x] 1.1 Create Footer component
  ...
  - [x] 1.2 Create PublicHeader component
  ...
  - [x] 1.3 Create CookieConsent component
  ...
  - [x] 1.4 Create PublicLayout component
...
- [x] 2. Checkpoint - Verify shared components render correctly
  - Ensure all shared components render without errors
  - Ask the user if questions arise

- [x] 3. Create legal pages
...
- [x] 4. Checkpoint - Verify legal pages render correctly
  - Ensure all legal pages render without errors
  - Verify header and footer appear on each page
  - Ask the user if questions arise

- [x] 5. Create Front Page
  - [x] 5.1 Create FrontPage component structure
  ...
  - [x] 5.3 Implement How It Works section
  ...
  - [x] 5.4 Implement Coffee Meeting section
...
- [x] 7. Update routing and navigation
  ...
  - [x] 7.2 Update existing Layout.jsx
  ...
  - [x] 7.3 Update auth pages to use PublicLayout
...
- [x] 8. Checkpoint - Verify navigation flows
...
- [x] 10. Final checkpoint - Ensure all tests pass
  ...
  - Note: 2 pre-existing seeding test failures (Property 1 & 4) unrelated to front-page changes
